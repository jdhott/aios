...
BACKUP_DIR="$PROJECT_ROOT/backups/metadata_reconciliation_phase1_6_$STAMP"
...
echo "=== AIOS Metadata Reconciliation Phase 1.6 Installer ==="
...
echo "$BACKUP_DIR" > "$PROJECT_ROOT/.metadata_reconciliation_phase1_6_last_backup"
