"""
AIOS Metadata Reconciliation — Phase 6.0 Governance Telemetry Summary
...
Phase 6.0 adds a compact governance telemetry summary for each run.
It does not expand mutation scope. The summary reports reconciliation cleanliness,
policy-driven action candidates, rank rewrite status, and authority boundaries in
a small grep-friendly block.
"""
...
VERSION = "metadata-reconciliation-phase6-governance-telemetry-summary-v0.6.0"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 6.0: GOVERNANCE TELEMETRY SUMMARY ===")
