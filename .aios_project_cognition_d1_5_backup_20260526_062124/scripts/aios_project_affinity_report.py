...
- previews active/open task affinity against historical neighborhoods
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="AIOS D1.4 historical project affinity telemetry with active-task preview")
