# AIOS Metadata Reconciliation Phase 2.3
...
tar -xzf ~/Downloads/aios_metadata_reconciliation_phase2_3.tar.gz
bash aios_metadata_reconciliation_phase2_3/install.sh
