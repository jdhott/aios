...
sample_pages = [
    ...
    {"id": "3", "properties": {"Task Name": prop_title("Deferred surfaced task"), "Done": prop_checkbox(False), "Defer Until": prop_date("2099-01-01"), "Best Next Action": prop_checkbox(True)}},
]
