...
('Supabase authority marker active','"authority": "supabase_review_authority_v1"' in run),
...
('Notion action fallback is legacy-only','and AIOS_DATASTORE == "notion"' in run and '.get_possible_duplicate_action(item)' in run),
]
