...
kwargs = dict(
    ...
    item=item,
    first_page={"id": "notion-task-page-1"},
...
first, first_created = shadow_clarification_review(**kwargs)
second, second_created = shadow_clarification_review(**kwargs)

if not first_created:
    raise RuntimeError("First shadow should be created.")
if second_created:
    raise RuntimeError("Second shadow should reuse existing review.")
if first.id != second.id:
    raise RuntimeError("Repeated shadow returned a different review.")
...
expected = {
    ...
    "clarification_mode": "procedural",
    "clarification_reason": "default_procedural",
    "notion_task_page_id": "notion-task-page-1",
    "task_title": "Clarify next action: Plan canning",
...
print("Original InboxItem identity bridge: PASS")
...
print("RESULT: CLARIFICATION REVIEW SHADOW V1 SMOKE TEST PASSED")
