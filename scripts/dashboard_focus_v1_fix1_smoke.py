...
focus={"id":"task-1","title":"Plan 90th birthday party for Mum","importance":"High Importance",
       "execution_rank":1,"execution_score":36,
       "starter_step":"Write down the 3–5 decisions that still need to be made for the party.",
       "starter_minutes":10}

sections={"top5":[
    focus,
    {"id":"task-2","title":"Prepare emergency kit for home","importance":"High Importance",
     "due_at":None,"is_quick_win":False,"is_just_do_it":False,
     "execution_rank":2,"execution_score":32,"best_next_action":True,
...
with patch.dict(os.environ,env,clear=False), \
     patch.object(web,"_fetch_open_tasks",lambda **k:sections), \
     patch.object(web,"_fetch_focus",lambda:focus):
...
print("Focus renders without UnboundLocalError: PASS")
print("Rank1 removed from Top 5: PASS")
print("Alternative sections collapsed by default: PASS")
print("RESULT: DASHBOARD FOCUS V1 FIX1 SMOKE TEST PASSED")
