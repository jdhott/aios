"""
AIOS Metadata Reconciliation — Phase 5.0 Policy-Driven Presentation Overlay Cleanup
...
Phase 5.0 extends policy-driven reconciliation to presentation overlays.
Quick Win remains presentation-only, but stale Quick Win state is now cleared
when a task is closed/done, future-deferred, or JDI. Do = Today remains
manual-only and is never mutated.
"""
...
VERSION = "metadata-reconciliation-phase5-policy-driven-presentation-overlay-cleanup-v0.5.0"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 5.0: POLICY-DRIVEN PRESENTATION OVERLAY CLEANUP ===")
