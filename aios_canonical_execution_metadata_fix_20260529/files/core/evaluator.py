...
def score_importance(importance) -> Tuple[int, Optional[str]]:

    if importance == "High Importance":
        return 25, "high_importance"

    if importance == "Medium Importance":
        return 10, "medium_importance"
...
def evaluate_ranking(task: Dict):
    ...
    scoring_functions = [
        lambda: score_importance(importance),
