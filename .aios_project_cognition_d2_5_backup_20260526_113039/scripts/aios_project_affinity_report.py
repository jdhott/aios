...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="AIOS D2.4 stability-governed Suggested Project persistence")
    ...
    parser.add_argument("--apply-suggested-project-writes", action="store_true", help="Apply the full guarded Suggested Project staging write plan. D2.4 otherwise applies only the stricter stability-governed subset by default.")
