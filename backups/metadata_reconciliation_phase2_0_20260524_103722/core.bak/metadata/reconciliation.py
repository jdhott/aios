"""
AIOS Metadata Reconciliation — Phase 1.12 Future-Deferred Surface Diagnostics
...
VERSION = "metadata-reconciliation-phase1-deferred-surface-diagnostics-v0.1.12"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.12: FUTURE-DEFERRED SURFACE DIAGNOSTICS + CLEANUPS ===")
