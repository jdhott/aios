"""
AIOS Metadata Reconciliation — Phase 1.10 Explicit Open Surface Mismatch Diagnostics
...
Adds diagnostics-only checks for open-task Best Next Action / Do = Today surface mismatches
...
VERSION = "metadata-reconciliation-phase1-explicit-open-surface-diagnostics-v0.1.10"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.10: EXPLICIT OPEN SURFACE DIAGNOSTICS + CLEANUPS ===")
    ...
    # Phase 1.10: make the open-surface diagnostics visible even when clean.
    open_surface_keys = {
