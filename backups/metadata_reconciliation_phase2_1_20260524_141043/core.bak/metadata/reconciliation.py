"""
AIOS Metadata Reconciliation — Phase 2.0 Closed-Task Persistence Guard + Reconciliation
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 2.0: CLOSED-TASK PERSISTENCE GUARD + CLEANUPS ===")
