"""
AIOS Metadata Reconciliation — Phase 1.9 Open Surface Mismatch Diagnostics
...
VERSION = "metadata-reconciliation-phase1-open-surface-mismatch-diagnostics-v0.1.9"
_MAX_EXAMPLES = 8
...
def scan_pages(pages: Iterable[Mapping[str, Any]]) -> ReconciliationSummary:
    ...
    for page in pages:
        ...
        # Phase 1.9 diagnostics-only: open-task execution/presentation surface mismatches.
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.9: OPEN SURFACE MISMATCH DIAGNOSTICS + CLEANUPS ===")
