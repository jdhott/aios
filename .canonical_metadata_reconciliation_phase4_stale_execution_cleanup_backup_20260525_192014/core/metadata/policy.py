...
VERSION = "canonical-metadata-policy-v0.1.0"
...
BEST_NEXT_ACTION = MetadataFieldPolicy(
    ...
    reconciliation_policy="diagnose_missing_rank_or_score; future_cleanup_candidate",
)
...
QUICK_WIN = MetadataFieldPolicy(
    ...
    mutation_policy="quick_win_lane_may_write; reconciliation_may_clear_when_deferred",
    reconciliation_policy="clear_on_deferred_future_only",
)
