...
- plans safe Suggested Project staging-field writes, emits stability telemetry, and derives canonical project preference memory
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="AIOS D2.2 canonical project preference memory telemetry")
