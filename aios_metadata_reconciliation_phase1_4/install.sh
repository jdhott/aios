...
BACKUP_DIR="$PROJECT_ROOT/backups/metadata_reconciliation_phase1_4_$STAMP"
...
echo "=== AIOS Metadata Reconciliation Phase 1.4 Installer ==="
...
Rollback created by metadata reconciliation phase 1.4 installer.
...
echo "$BACKUP_DIR" > "$PROJECT_ROOT/.metadata_reconciliation_phase1_4_last_backup"
...
echo "grep -E 'METADATA RECONCILIATION|Metadata Reconciliation|Deferred future|Would clear Quick Win|Applying Quick Win|Clearing Quick Win|Quick Win cleared|Mutation error' test_run.log"
