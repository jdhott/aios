"""
AIOS Metadata Reconciliation — Phase 1.4 Quick Win Deferred Cleanup

Narrow mutation reconciliation layer. Clears stale Quick Win flags only when
a task is deferred to a future date. All other findings remain diagnostics-only.
...
VERSION = "metadata-reconciliation-phase1-quick-win-deferred-cleanup-v0.1.4"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.4: QUICK WIN DEFERRED CLEANUP ===")
