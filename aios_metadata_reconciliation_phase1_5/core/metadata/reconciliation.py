"""
AIOS Metadata Reconciliation — Phase 1.5 Closed Task Diagnostics
...
tasks. Adds diagnostics-only detection for completed/closed tasks that still
carry active execution or presentation metadata.
...
VERSION = "metadata-reconciliation-phase1-closed-task-diagnostics-v0.1.5"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.5: CLOSED TASK DIAGNOSTICS + QUICK WIN CLEANUP ===")
