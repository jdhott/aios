...
class AffinitySummary:
    ...
    def telemetry_lines(self) -> List[str]:
        lines = [
            "=== PROJECT COGNITION — D2.1: SUGGESTED PROJECT STABILITY TELEMETRY ===",
        ...
        lines.append("[Project Cognition] D2.1 mode: dry_run_default=true; writes=0_unless_apply_flag; project_relation_mutation=disabled; execution_authority_impact=none")
        return lines
