...
from core.metadata.reconciliation import scan_pages, format_summary, collect_quick_win_deferred_cleanup_actions, collect_closed_execution_cleanup_actions, collect_execution_rank_canonicalization_actions
...
assert len(rank_actions) == 1
assert rank_actions[0]["title"] == "Rank four"
assert rank_actions[0]["current_rank"] == 4
assert rank_actions[0]["new_rank"] == 3
