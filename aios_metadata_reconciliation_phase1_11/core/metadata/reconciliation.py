"""
AIOS Metadata Reconciliation — Phase 1.11 JDI Stale Metadata Diagnostics
...
Adds diagnostics-only checks for open-task Best Next Action / Do = Today surface mismatches and JDI stale execution/presentation metadata
...
VERSION = "metadata-reconciliation-phase1-jdi-stale-metadata-diagnostics-v0.1.11"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.11: JDI STALE METADATA DIAGNOSTICS + CLEANUPS ===")
