...
BACKUP_DIR="$PROJECT_ROOT/backups/metadata_reconciliation_phase1_8_$STAMP"
...
echo "=== AIOS Metadata Reconciliation Phase 1.8 Installer ==="
...
echo "$BACKUP_DIR" > "$PROJECT_ROOT/.metadata_reconciliation_phase1_8_last_backup"
...
echo "grep -E 'METADATA RECONCILIATION|Metadata Reconciliation|Closed/done|Applying closed|Clearing closed|metadata cleared|Quick Win cleared|Mutation error' test_run.log"
