...
BACKUP_DIR="$PROJECT_ROOT/backups/metadata_reconciliation_phase1_7_$STAMP"
...
echo "=== AIOS Metadata Reconciliation Phase 1.7 Installer ==="
...
echo "$BACKUP_DIR" > "$PROJECT_ROOT/.metadata_reconciliation_phase1_7_last_backup"
