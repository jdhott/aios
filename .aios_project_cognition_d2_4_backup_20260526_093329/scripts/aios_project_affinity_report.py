...
- plans safe Suggested Project staging-field writes, emits stability telemetry, and derives canonical preference assisted suppression
- performs no writes unless --apply-suggested-project-writes is explicitly passed
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="AIOS D2.3 canonical preference assisted suppression telemetry")
    ...
    parser.add_argument("--apply-suggested-project-writes", action="store_true", help="Apply bounded writes to the Suggested Project staging field. Default is dry-run.")
    ...
    if args.json:
        ...
        if args.apply_suggested_project_writes:
            ...
            print(
                ...
                "relation_mutations=0; execution_authority_impact=none"
            )
            ...
            print(
                "[Project Cognition] Suggested Project writes applied: "
                "applied=0; dry_run=true; pass --apply-suggested-project-writes to stage safe suggestions"
            )
