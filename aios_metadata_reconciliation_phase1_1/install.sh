...
BACKUP_DIR="$PROJECT_ROOT/backups/metadata_reconciliation_phase1_1_$STAMP"
...
echo "=== AIOS Metadata Reconciliation Phase 1.1 Installer ==="
...
Rollback created by metadata reconciliation phase 1.1 installer.
...
echo "$BACKUP_DIR" > "$PROJECT_ROOT/.metadata_reconciliation_phase1_1_last_backup"
...
echo "grep -E 'METADATA RECONCILIATION|Metadata Reconciliation|Deferred future' test_run.log"
