"""
AIOS Metadata Reconciliation — Phase 1.1 Detailed Diagnostics
...
VERSION = "metadata-reconciliation-phase1-detailed-diagnostics-v0.1.1"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.1: DETAILED DIAGNOSTICS ONLY ===")
