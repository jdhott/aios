...
BACKUP_DIR="$TARGET_DIR/.aios_project_cognition_d1_3_backup_$(date +%Y%m%d_%H%M%S)"
...
cp "$PACKAGE_DIR/smoke_test_project_cognition_d1_3.sh" "$TARGET_DIR/smoke_test_project_cognition_d1_3.sh"
chmod +x "$TARGET_DIR/scripts/aios_project_affinity_report.py" "$TARGET_DIR/smoke_test_project_cognition_d1_3.sh"

echo "$BACKUP_DIR" > "$TARGET_DIR/.last_aios_project_cognition_d1_3_backup"

echo "Installed AIOS Project Cognition D1.3 project name resolution package."
