...
class AffinitySummary:
    ...
    def telemetry_lines(self) -> List[str]:
        lines = [
            "=== PROJECT COGNITION — D1.6: HISTORICAL AFFINITY TELEMETRY ===",
        ...
        lines.append("[Project Cognition] Strong-domain confidence: anchor_terms_enabled=true; broad_terms_still_suppressed=true")
...
def _confidence_for_score(
    ...
    *,
    ...
    D1.6 allows one highly specific anchor-domain term to produce high confidence
    when historical support is strong. Broad/weak terms remain unable to do this.
    """
    if score >= 16 and anchor_terms >= 1:
        return "high"
