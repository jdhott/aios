"""
AIOS Metadata Reconciliation — Phase 1.3 Quick Win Reconciliation Preview

Diagnostics-only reconciliation layer with read-only Quick Win cleanup preview.
...
VERSION = "metadata-reconciliation-phase1-quick-win-preview-v0.1.3"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.3: QUICK WIN RECONCILIATION PREVIEW ONLY ===")
    ...
    lines.append("[Metadata Reconciliation] Preview only. No Notion mutations performed.")
    return lines
