...
assert "D1.6" in lines
assert "Strong-domain confidence" in lines
...
print("D1.6 smoke test passed: strong-domain confidence calibrated; broad terms suppressed; writes=0")
PY
