"""
AIOS Metadata Reconciliation — Phase 1.2 Grep-Visible Detailed Diagnostics
...
VERSION = "metadata-reconciliation-phase1-grep-visible-details-v0.1.2"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 1.2: GREP-VISIBLE DETAILED DIAGNOSTICS ONLY ===")
