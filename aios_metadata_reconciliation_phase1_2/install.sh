...
BACKUP_DIR="$PROJECT_ROOT/backups/metadata_reconciliation_phase1_2_$STAMP"
...
echo "=== AIOS Metadata Reconciliation Phase 1.2 Installer ==="
...
echo "$BACKUP_DIR" > "$PROJECT_ROOT/.metadata_reconciliation_phase1_2_last_backup"
...
echo "grep -E 'METADATA RECONCILIATION|Metadata Reconciliation|Finding detail|Deferred future' test_run.log"
