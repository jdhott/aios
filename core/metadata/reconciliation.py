"""
AIOS Metadata Reconciliation — Phase 2.3 True Canonical Rank Rewrite + Diagnostics
...
VERSION = "metadata-reconciliation-phase2-true-canonical-rank-rewrite-v0.2.3"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 2.3: TRUE CANONICAL RANK REWRITE + CLEANUPS ===")
