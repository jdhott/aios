"""
AIOS Metadata Reconciliation — Phase 3.0 Canonical Policy Registry
...
Phase 3.0 adds a canonical metadata policy registry so field ownership and
reconciliation boundaries are declared once instead of re-encoded throughout
...
VERSION = "metadata-reconciliation-phase3-canonical-policy-registry-v0.3.0"
_MAX_EXAMPLES = 8
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 3.0: CANONICAL POLICY REGISTRY + RECONCILIATION ===")
