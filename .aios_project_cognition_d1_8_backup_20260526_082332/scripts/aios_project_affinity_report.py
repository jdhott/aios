...
- previews active/open task affinity with weak-term weighting, strong-domain confidence, and runner-up ambiguity telemetry
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="AIOS D1.7 historical project affinity telemetry with active-task runner-up ambiguity")
