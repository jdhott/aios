...
- previews active/open task affinity with weak-term weighting against historical neighborhoods
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="AIOS D1.5 historical project affinity telemetry with weak-term active-task preview")
