...
_WEAK_TERMS = {
    ...
    "pickup", "delivery", "print", "printed", "printing", "label", "labels", "bag", "bags",
    "basement", "kitchen", "home", "house", "car", "costco", "grocery", "groceries",
}

_STRONG_SIGNAL_TERMS = {
    "pool", "skimmer", "chlorine", "filter", "vacuum", "workshop", "pizza", "teaching",
...
class AffinitySummary:
    ...
    def telemetry_lines(self) -> List[str]:
        lines = [
            "=== PROJECT COGNITION — D1.5: HISTORICAL AFFINITY TELEMETRY ===",
...
def _confidence_for_score(score: int, *, strong_terms: int = 0, evidence_terms: int = 0) -> str:
    ...
    *,
    ...
    for task in active_tasks:
        ...
        for neighborhood in neighborhoods:
            ...
            # Weight matches by historical strength, but discount broad/weak terms and
            # require either a strong operational term or several overlapping weak terms.
            # This prevents broad one-token matches like "bread" from becoming high confidence.
            score = sum(
            ...
            candidate = {
                ...
                "score": score,
                "confidence": _confidence_for_score(score, strong_terms=len(set(strong_overlap_terms)), evidence_terms=evidence_terms),
