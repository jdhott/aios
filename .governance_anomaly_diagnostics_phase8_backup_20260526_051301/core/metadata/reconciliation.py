"""
AIOS Metadata Reconciliation — Phase 7.0 Compact Governance Logging
...
Phase 7.0 keeps the governance telemetry summary as the default observability
surface while suppressing older verbose per-row diagnostics unless explicitly
enabled by environment flags. It does not expand mutation scope.
"""
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 7.0: COMPACT GOVERNANCE LOGGING ===")
