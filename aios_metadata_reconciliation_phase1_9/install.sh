...
BACKUP_DIR="$PROJECT_ROOT/backups/metadata_reconciliation_phase1_9_$STAMP"
...
echo "=== AIOS Metadata Reconciliation Phase 1.9 Installer ==="
...
Rollback created by metadata reconciliation phase 1.8 installer.
...
echo "$BACKUP_DIR" > "$PROJECT_ROOT/.metadata_reconciliation_phase1_9_last_backup"
...
echo "grep -E 'METADATA RECONCILIATION|Metadata Reconciliation|Open tasks with Do = Today|Open Best Next Action|Closed/done|Quick Win deferred cleanup|Closed/done execution cleanup|Mutation error' test_run.log"
