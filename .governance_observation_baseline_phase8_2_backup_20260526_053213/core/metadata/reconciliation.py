"""
AIOS Metadata Reconciliation — Phase 8.1 Deprecated Metadata Cleanup
...
VERSION = "metadata-reconciliation-phase8-1-deprecated-metadata-cleanup-v0.8.1"
_MAX_EXAMPLES = 8
...
def collect_deprecated_metadata_cleanup_actions(pages: Iterable[Mapping[str, Any]]) -> List[Dict[str, Any]]:
    ...
    Phase 8.1 promotes a validated Phase 8 anomaly signal into a safe cleanup:
    clear checked deprecated legacy boolean fields so they no longer create
    recurring governance attention. This does not touch canonical execution
...
def format_summary(summary: ReconciliationSummary) -> List[str]:
    lines = []
    lines.append("=== METADATA RECONCILIATION — PHASE 8.1: DEPRECATED METADATA CLEANUP ===")
