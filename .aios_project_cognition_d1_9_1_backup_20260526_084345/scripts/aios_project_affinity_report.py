...
- previews active/open task affinity with weak-term weighting, strong-domain confidence, runner-up ambiguity telemetry, and overlapping project-neighborhood detection
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="AIOS D1.8 historical project affinity telemetry with project-neighborhood overlap detection")
